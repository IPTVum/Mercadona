        ...
        <div className="absolute top-0 left-0 right-0 z-[3]">
          <div className="container-custom py-4">
            <nav className="flex items-center gap-1.5 text-sm text-white/70">
              ...
              <Link href="/blog" className="hover:text-white transition-colors">{t('title')}</Link>
              <ChevronRight size={14} className="text-white/40" />
          ...
          <div className="mt-12 pt-8 border-t border-gray-200">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="font-semibold text-gray-900 text-lg">{t('byAuthor', { author: blog.author?.full_name || 'Admin' })}</p>
        ...
        <div className="bg-gradient-to-b from-gray-50 to-white py-16 md:py-20">
          <div className="container-custom">
            <div className="flex items-center justify-between mb-10">
              <div>
                <h2 className="text-2xl md:text-3xl font-display font-bold text-gray-900">{t('relatedPosts')}</h2>
