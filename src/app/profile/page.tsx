          ...
          {activeTab === 'profile' && (
            <div className="bg-white p-6 rounded-xl border border-gray-200">
              ...
              <button onClick={handleSaveProfile} disabled={saving} className="mt-6 btn-primary disabled:opacity-50">
                {saving ? <><Loader2 className="animate-spin" size={20} /> Saving...</> : 'Save Changes'}
              </button>
            </div>
          )}
            ...
            <div className="bg-white p-6 rounded-xl border border-gray-200">
              ...
              {orders.length > 0 ? (
                              ...
                              <div>
                                ...
                                {order.tracking_number && (
                                  <p className="mt-2 text-sm">
                                    <span className="text-gray-500">Tracking:</span> <span className="font-medium">{order.tracking_number}</span>
                                  </p>
                                )}
                              </div>
                            ) : (
                ...
                <div className="text-center py-12">
                  ...
                  <Link href="/shop" className="mt-4 inline-block text-primary-600 hover:text-primary-700">Start Shopping</Link>
                </div>
              )}
            </div>
          )}
            ...
            <div className="bg-white p-6 rounded-xl border border-gray-200">
              ...
              {hasMounted && wishlistItems.length > 0 ? (
                ...
                <div className="text-center py-12">
                  ...
                  <Link href="/shop" className="mt-4 inline-block text-primary-600 hover:text-primary-700">Browse Products</Link>
                </div>
              )}
            </div>
          )}
                  ...
                  {!showShippingForm ? (
                    shippingAddress.name ? (
                      <div className="text-sm text-gray-600 space-y-1">
                        ...
                        <button onClick={() => setShowShippingForm(true)} className="mt-2 text-primary-600 hover:text-primary-700 text-sm">Edit</button>
                      </div>
                    ) : (
                      <div className="text-center py-4">
                        <MapPin size={24} className="mx-auto text-gray-300 mb-2" />
                        <p className="text-gray-500 text-sm">No shipping address</p>
                        <button onClick={() => setShowShippingForm(true)} className="mt-2 text-primary-600 hover:text-primary-700 text-sm">Add Address</button>
                      </div>
                    )
                  ) : (
                    <div className="space-y-3">
                      ...
                      <div className="flex gap-2">
                        <button onClick={() => handleSaveAddress('shipping')} disabled={saving} className="btn-primary text-sm disabled:opacity-50">Save</button>
                        <button onClick={() => setShowShippingForm(false)} className="btn-outline text-sm">Cancel</button>
                      </div>
                    </div>
                  )}
                </div>
                  ...
                  {!showBillingForm ? (
                    billingAddress.name ? (
                      <div className="text-sm text-gray-600 space-y-1">
                        ...
                        <button onClick={() => setShowBillingForm(true)} className="mt-2 text-primary-600 hover:text-primary-700 text-sm">Edit</button>
                      </div>
                    ) : (
                      <div className="text-center py-4">
                        <MapPin size={24} className="mx-auto text-gray-300 mb-2" />
                        <p className="text-gray-500 text-sm">No billing address</p>
                        <button onClick={() => setShowBillingForm(true)} className="mt-2 text-primary-600 hover:text-primary-700 text-sm">Add Address</button>
                      </div>
                    )
                  ) : (
                    <div className="space-y-3">
                      ...
                      <div className="flex gap-2">
                        <button onClick={() => handleSaveAddress('billing')} disabled={saving} className="btn-primary text-sm disabled:opacity-50">Save</button>
                        <button onClick={() => setShowBillingForm(false)} className="btn-outline text-sm">Cancel</button>
                      </div>
                    </div>
                  )}
                </div>
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    ...
                    <button onClick={handleChangePassword} disabled={saving} className="btn-primary disabled:opacity-50">
                      {saving ? <><Loader2 className="animate-spin" size={20} /> Updating...</> : 'Update Password'}
                    </button>
                  </div>
                </div>
