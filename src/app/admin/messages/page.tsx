...
export default function AdminMessagesPage() {
  ...
  if (loading) {
    return (
      <div>
        <h1 className="text-2xl md:text-3xl font-bold mb-8">Contact Messages</h1>
          ...
          {selected ? (
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 flex items-center justify-center py-20">
              <div className="text-center text-gray-400">
                ...
                <p className="font-medium text-gray-500">Select a message</p>
                <p className="text-sm mt-1">Click on a message from the list to view it</p>
              </div>
            </div>
          )}
        </div>
